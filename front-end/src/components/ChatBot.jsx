...
function ChatBot(props) {
  ...
  let [sourceData, SetSourceData] = useState("haui");
  ...
  const [dataChat, SetDataChat] = useState([
    [
      "start",
      [
        "Xin chào! Đây là HaUI Chatbot, trợ lý đắc lực dành cho bạn! Bạn muốn tìm kiếm thông tin về những gì? Đừng quên chọn nguồn tham khảo phù hợp để mình có thể giúp bạn tìm kiếm thông tin chính xác nhất nha. 😄",
        null,
      ],
    ],
  ]);
  ...
  async function SendMessageChat() {
    if (promptInput !== "" && isLoading === false) {
      ...
      fetch("https://internal-grubworm-grossly.ngrok-free.app/rag/" + sourceData + "?q=" + promptInput,
      {
        method: "get",
        headers: new Headers({
    ...
    SetReference({
      title:
        sourceType == "wiki"
          ...
          : sources.metadata.page==undefined? "DHCN DB" : "Trang " + sources.metadata.page + " (sổ tay SV)",
      source: sourceType == "wiki" ? "Wikipedia" : "Đại học Công nghiệp Hà Nội",
      url:
        sourceType == "wiki"
                        ...
                        {dataMessages[1][1].map((source, j) => (
                          ...
                          >
                            {dataMessages[1][2] == "wiki"
                              ...
                              : source.metadata.page==undefined? "DHCN DB" : "Trang " +
                ...
                <div className="chat-bubble shadow-xl chat-bubble-primary bg-gradient-to-r from-purple-500 to-blue-500 text-white">
                  ...
                  <>
                    ...
                    <p className="font-light text-xs text-cyan-50">
                      Tham khảo:{" "}
                      {dataMessages[1][1] == "wiki" ? "Wikipedia" : "haui"}
                    </p>
                  </>
                </div>
              </div>
